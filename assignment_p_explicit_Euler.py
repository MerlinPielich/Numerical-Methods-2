...
if __name__ == '__main__':
    ...
    phi0 = fn.copy() #np.clip(fn.copy(), 0, 1) # Initial image (noisy) but clipped to [0, 1]
    ...
    phi_filtered = explicit_euler_anisotropic_diffusion(phi0, lambda_val, K, h, dt, n_steps, c_const = False)
    phi_filtered_const = explicit_euler_anisotropic_diffusion(phi0, lambda_val, K, h, dt, n_steps, c_const = True)
